...
This document defines the design tokens and micro-interactions used across the
Hypermarket platform (Mobile RN + Admin Web).
...
All tokens are defined in `@hypermarket/design-tokens` and shared between
platforms.
...
import {
  ...
  typography,
  radius,
} from '@hypermarket/design-tokens';
```
...
**What:** Scale pulse + haptic feedback when adding item to cart **When:** User
taps "Add to Cart" button **How:**
...
**What:** Subtle fade + slide for screen/element entry **When:** Navigation,
list loading, modal entry **How:**
...
**What:** Animated placeholder while content loads **When:** API calls, image
loading, initial render **How:**
