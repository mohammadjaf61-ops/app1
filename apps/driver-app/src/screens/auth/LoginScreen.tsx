      ...
      >
        <View className="flex-1 justify-center px-6">
          ...
          <View className="items-center mb-12">
            ...
            <Text className="text-3xl font-bold text-gray-900 mb-2">تطبيق التوصيل</Text>
            <Text className="text-gray-500 text-lg text-center">مخصص لسائقي التوصيل</Text>
          </View>
          ...
          {/* Info */}
          <View className="mt-8 bg-sky-50 p-4 rounded-xl">
            <View className="flex-row items-center justify-end mb-2">
              <Text className="text-sky-800 font-bold mr-2">ملاحظة</Text>
              <Ionicons name="information-circle" size={20} color="#0284c7" />
            </View>
            <Text className="text-sky-700 text-right">
              هذا التطبيق مخصص للسائقين فقط. إذا كنت موظف تجهيز، يرجى استخدام تطبيق التجهيز.
            </Text>
          </View>
        </View>
